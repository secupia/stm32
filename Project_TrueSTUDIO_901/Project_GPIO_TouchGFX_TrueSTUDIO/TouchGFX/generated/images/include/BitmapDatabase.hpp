...
const uint16_t BITMAP_BK1_ID = 0; // Size: 480x272 pixels
const uint16_t BITMAP_BK2_ID = 1; // Size: 480x272 pixels
const uint16_t BITMAP_BK3_ID = 2; // Size: 480x272 pixels
